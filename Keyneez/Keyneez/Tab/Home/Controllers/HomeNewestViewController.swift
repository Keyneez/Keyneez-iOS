...
final class HomeNewestViewController: UIViewController {
  
  // MARK: - CollectionView
  private lazy var newestContentCollectionView: UICollectionView = {
  ...
  private func register() {
    newestContentCollectionView.register(
      HomeContentCollectionViewCell.self,
      forCellWithReuseIdentifier: HomeContentCollectionViewCell.identifier)
  }
  
  private func setLayout() {
    view.addSubviews(newestContentCollectionView)
    newestContentCollectionView.snp.makeConstraints {
...
extension HomeNewestViewController: UICollectionViewDataSource {
