...
class PropensityTagCollectionViewController: NiblessView {
  ...
  private lazy var activeButton: UIButton = .init().then {
    $0.tag = 0
  ...
  private lazy var curiousButton: UIButton = .init().then {
    $0.tag = 1
    $0.isSelected = false
    $0.propensityTagButtonStyle(style: .propensityTagUnact, title: propensityTagUnclickData[$0.tag].text)
    $0.isUserInteractionEnabled = true
  ...
  private lazy var comportableButton: UIButton = .init().then {
    $0.tag = 2
    $0.isSelected = false
    $0.propensityTagButtonStyle(style: .propensityTagUnact, title: propensityTagUnclickData[$0.tag].text)
    $0.isUserInteractionEnabled = true
